...
m46[!is.na(m46$B11),'B11THD'] <- m46[!is.na(m46$B11),'THD1']
m46[!is.na(m46$B12),'B12THD'] <- m46[!is.na(m46$B12),'THD1']
m46[!is.na(m46$B21),'B21THD'] <- m46[!is.na(m46$B21),'THD1']
m46[!is.na(m46$B22),'B22THD'] <- m46[!is.na(m46$B22),'THD1']

m46 <- m46 %>% fill(B11, B11time, B12, B12time, B21, B21time, B22, B22time,B11THD,B12THD,B21THD,B22THD)

m46$B11THD = (m46$THD1-m46$B11THD)/m46$B11THD
m46$B12THD = (m46$THD1-m46$B12THD)/m46$B12THD
m46$B21THD = (m46$THD1-m46$B21THD)/m46$B21THD
m46$B22THD = (m46$THD1-m46$B22THD)/m46$B22THD



m60[!is.na(m60$B11),'B11THD'] <- m60[!is.na(m60$B11),'THD1']
m60[!is.na(m60$B12),'B12THD'] <- m60[!is.na(m60$B12),'THD1']
m60[!is.na(m60$B21),'B21THD'] <- m60[!is.na(m60$B21),'THD1']
m60[!is.na(m60$B22),'B22THD'] <- m60[!is.na(m60$B22),'THD1']

m60 <- m60 %>% fill(B11, B11time, B12, B12time, B21, B21time, B22, B22time,B11THD,B12THD,B21THD,B22THD)

m60$B11THD = (m60$THD1-m60$B11THD)/m60$B11THD
m60$B12THD = (m60$THD1-m60$B12THD)/m60$B12THD
m60$B21THD = (m60$THD1-m60$B21THD)/m60$B21THD
m60$B22THD = (m60$THD1-m60$B22THD)/m60$B22THD
...
write.csv(m46, "data/combined/46combined1.csv", row.names=FALSE)
write.csv(m60, "data/combined/60combined1.csv", row.names=FALSE)
write.csv(B11extra, "data/combined/B11extra1.csv", row.names=FALSE)
write.csv(B12extra, "data/combined/B12extra1.csv", row.names=FALSE)
write.csv(B21extra, "data/combined/B21extra1.csv", row.names=FALSE)
write.csv(B22extra, "data/combined/B22extra1.csv", row.names=FALSE)